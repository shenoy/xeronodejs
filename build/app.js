...
app.get("/connect", (req, res) => __awaiter(this, void 0, void 0, function* () {
    try {
...
app.get("/starter/Callback", (req, res) => __awaiter(this, void 0, void 0, function* () {
    try {
...
app.get("/reports", (req, res) => __awaiter(this, void 0, void 0, function* () {
    try {
